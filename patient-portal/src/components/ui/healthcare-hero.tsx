...
export function HealthcareHero({
  badge = "🚀 Now Available Across Ontario",
  title1 = "Your Health,",
  title2 = "Your Schedule",
  description = "Book appointments with healthcare providers across Ontario. Find specialists, manage your insurance, and take control of your healthcare journey.",
  className,
}: HealthcareHeroProps) {
  ...
  return (
    <div className={cn("relative w-full flex items-center justify-center overflow-hidden bg-background", 
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Mobile: Hide some shapes to prevent overflow */}
        ...
        {/* Mobile: Show only essential shapes */}
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 md:px-6 py-16 md:py-0">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/[0.03] border border-primary/[0.08] mb-8 md:mb-12"
          >
            <Heart className="h-3 w-3 fill-primary/80" />
...
export type { ElegantShapeProps, HealthcareHeroProps };
