...
export const ToolHeader = ({
  ...
  const getToolIcon = (toolType: string) => {
    const iconMap: Record<string, ReactNode> = {
      ...
      "Specialists": <Stethoscope className="size-4" />,
      "Appointment Times": <Calendar className="size-4" />,
      "Booking Appointment": <Calendar className="size-4" />,
      "Current Page": <User className="size-4" />,
    };
